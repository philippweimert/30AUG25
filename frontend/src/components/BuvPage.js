  ...
  const benefits = [
    {
      ...
      title: "Erweiterte Unfallabsicherung",
      description: "Umfassender Schutz bei Unfällen während und außerhalb der Arbeitszeit"
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Mitarbeitervorsorge",
      description: "Wertvoller Mitarbeiterbenefit zur Steigerung der Zufriedenheit und Bindung"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Schnelle Hilfe",
      description: "24/7 Notfallservice und schnelle medizinische Versorgung im Schadensfall"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
                die <span className="text-orange-500">bUV</span>
              </h1>
              <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto">
                Betriebliche Unfallversicherung - erweiterte Absicherung über den gesetzlichen Schutz hinaus
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-200 max-w-3xl mx-auto">
                Die bUV erweitert den gesetzlichen Unfallschutz und bietet umfassende Absicherung
              </p>
            </div>
