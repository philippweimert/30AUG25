  ...
  const benefits = [
    {
      ...
      description: "Umfassende Absicherung bei Unfällen während und außerhalb der Arbeitszeit"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Gesundheitsvorsorge",
      description: "Präventive Maßnahmen und schnelle medizinische Versorgung"
    },
    {
      icon: <Clock className="w-6 h-6" />,
      title: "Schnelle Hilfe",
      description: "24/7 Notfallservice und schnelle Schadensabwicklung"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
                bUV für <span className="text-orange-500">Arbeitnehmer</span>
              </h1>
              <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto">
                Ihre betriebliche Unfallversicherung - optimaler Schutz über den gesetzlichen Rahmen hinaus
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                Ihre Vorteile bei der bUV
              </h2>
              <p className="text-lg text-slate-200 max-w-3xl mx-auto">
                Profitieren Sie von umfassendem Schutz und zusätzlichen Leistungen
              </p>
            </div>
